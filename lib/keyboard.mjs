...
function getKeyPressed(keyCode) {
  return keyMap[keyCode]
    .replace("l", parseInt(keyOctave, 10) + keyPressOffset)
    .replace("u", (parseInt(keyOctave, 10) + keyPressOffset + 1).toString())
}
...
function keyboardDown(key, callback) {
  ...
  if (typeof keyMap[key.keyCode] !== "undefined") {
    ...
    callback(key_pressed, calcFrequency(key_pressed))
...
function addListeners(keyboardEl) {
  ...
  //       return
  //     }
  //     if (keyboardDown(key, that.keyDownCallback)) {
  //       key.preventDefault()
  //     }
  //   })
  ...
  //       return
  //     }
  //     if (keyboardUp(key, that.keyUpCallback)) {
  //       key.preventDefault()
  //     }
  //   })
  // }
