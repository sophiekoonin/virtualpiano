 ...
 */
function lightenUp(el) {
  if (el !== null || typeof el === undefined) {
    el.classList.add("note-pressed")
  }
}
 ...
 * @param  {element} el DOM element to change colour of.
 */
function darkenDown(el) {
  if (el !== null) {
    el.classList.remove("note-pressed")
  }
}
...
function setKeyPressOffset(sorted_white_notes) {
 ...
 */
export function QwertyHancock(settings) {
