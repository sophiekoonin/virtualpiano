...
export function calcFrequency(_note, octave) {
  let note = _note
  if (!octave) {
    note = _note.split(/[0-9]/g)[0]
    octave = _note.substring(_note.length - 1)
  }

  const sameOctaveDistanceFromA = SingleOctaveIntervals[note] // A -> C is -9
